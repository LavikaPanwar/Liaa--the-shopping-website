...
function getIconForProduct(category) {
    const icons = {
    ...
    grid.innerHTML = productsToRender.map(product => `
        <div class="product-card" data-category="${product.category}" onclick="openProductModal(${product.id})">
            <div class="product-image">
                <i class="${getIconForProduct(product.category)} fa-3x"></i>
            </div>
            <div class="product-info">
                ...
                <div class="product-actions">
                    ...
                    <button class="btn btn-secondary" onclick="event.stopPropagation(); openProductModal(${product.id})">View Details</button>
                </div>
            </div>
        </div>
    `).join('');
